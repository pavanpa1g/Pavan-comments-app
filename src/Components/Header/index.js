...
const Header = () => {
  ...
  return (
    <div className="header-bg ">
      <Link href="/" className="text-black text-xl font-semibold mr-auto " style={{marginRight:'auto'}}>
        <h1>Images</h1>
      </Link>
      <Link href="/profile" className="mr-4 hov">
        <BsPersonCircle style={{ color: profileColor }} size={26} />
      </Link>
      <Link href="/chats" className="hov">
        <svg
      ...
      <button
        className="logout-button color-logout-button"
        onClick={onLogout}
      >
        Logout
      </button>
